...
struct gsshortdata {
    gsshortdata() {
        memset(this, 0, sizeof(gsshortdata));
    }
...
struct craneinfostruct : public parentstruct {
    ...
    QString elem0ToUTF16() {
        return elemToUTF16(elem0, sizeof(elem0));
    }
    QString elem1ToUTF16() {
        return elemToUTF16(elem1, sizeof(elem1));
    }
    QString elem2ToUTF16() {
        return elemToUTF16(elem2, sizeof(elem2));
    }
    QString elem3ToUTF16() {
        return elemToUTF16(elem3, sizeof(elem3));
    }
    QString elem7ToUTF16() {
        return elemToUTF16(elem7, sizeof(elem7));
    }
    QString elem8ToUTF16() {
        return elemToUTF16(elem8, sizeof(elem8));
    }
    QString elem9ToUTF16() {
        return elemToUTF16(elem9, sizeof(elem9));
    }
    QString elem12ToUTF16() {
        return elemToUTF16(elem12, sizeof(elem12));
    }
    QString elem13ToUTF16() {
        return elemToUTF16(elem13, sizeof(elem13));
    }
    QString elem14ToUTF16() {
        return elemToUTF16(elem14, sizeof(elem14));
    }
    QString elem15ToUTF16() {
        return elemToUTF16(elem15, sizeof(elem15));
    }
    QString elem18ToUTF16() {
        return elemToUTF16(elem18, sizeof(elem18));
    }
};
...
struct peripherystruct : public parentstruct {
    ...
    static const quint8 STRUCT_SIZE{31};
    ...
    peripherystruct& operator=(const peripherystruct& other) {
        if (this != &other) {
            arg = other.arg;
            type_interface = other.type_interface;
            num_interface = other.num_interface;
            id = other.id;
            start = other.start;
            size = other.size;
            conv = other.conv;
            ...
            reserv_1 = other.reserv_1;
            reserv_2 = other.reserv_2;
            reserv_3 = other.reserv_3;
            ratio = other.ratio;
            settings = other.settings;
            strncpy(name, other.name, 10);
            filter = other.filter;
            strncmp(description, other.description, 256);
        }
        return *this;
    }
};
